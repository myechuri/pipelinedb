...
CREATE STREAM box_stream ();
CREATE STREAM polygon_stream ();
CREATE STREAM circle_stream ();
CREATE STREAM cidr_stream ();
CREATE STREAM inet_stream ();
CREATE STREAM bit_stream ();
CREATE STREAM varbit_stream ();
CREATE STREAM int8_stream ();
CREATE STREAM int4_stream ();
CREATE STREAM bool_stream ();
CREATE STREAM json_stream ();
CREATE STREAM jsonb_stream ();
...
DROP STREAM box_stream CASCADE;
DROP STREAM polygon_stream CASCADE;
DROP STREAM circle_stream CASCADE;
DROP STREAM cidr_stream CASCADE;
DROP STREAM inet_stream CASCADE;
DROP STREAM bit_stream CASCADE;
DROP STREAM varbit_stream CASCADE;
DROP STREAM int8_stream CASCADE;
DROP STREAM int4_stream CASCADE;
DROP STREAM bool_stream CASCADE;
DROP STREAM json_stream CASCADE;
DROP STREAM jsonb_stream CASCADE;
