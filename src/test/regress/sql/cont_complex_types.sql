...
CREATE STREAM cont_complex_stream ();
...
CREATE CONTINUOUS VIEW test_cont_complex4 AS SELECT bloom_agg(z::text) FROM cont_complex_stream;
...
DROP STREAM cont_complex_stream CASCADE;
